...
For instructions that include screenshots, see [End-user enrollment instructions](https://gallery.technet.microsoft.com/End-user-Intune-enrollment-55dfd64a).

1.  Follow the steps in  [Install and sign in to the Intune Company Portal app](#BKMK_ios_signin_cp).

2.  On the Company Portal **Welcome** screen, tap **Sign in**, and then sign in with your work or school account.

3.  If your IT administrator set up company terms and conditions, tap **ACCEPT** to accept the terms.

4. On the **Company Access Setup** screen, tap **BEGIN**.

5. On the **Why enroll your device?** screen, read about what you’ll be able to do when you enroll your device, and then tap **CONTINUE**.

6.  On the **privacy** screen, see the list of what your IT administrator can and can’t see on your enrolled device, and tap **CONTINUE**.

7.  On the What comes next? screen, review some of the things that you might see once you tap Enroll. When you finish reading, tap ENROLL.  

8.  On the **Install Profile** screen, tap **Install**, and enter your passcode, if prompted.
...
10.  Tap **Install** to indicate that you've read the warning.
...
13.  Tap **OK**. Your device is now enrolled in Intune.
...
> [!WARNING]
> Resetting a device to factory defaults removes both your personal and work information from your device.
...
## <a name="BKMK_ios_reset_device"></a>What happens if I reset my iOS device using the Company Portal?
