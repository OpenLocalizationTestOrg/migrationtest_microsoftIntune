...
1.  In the [Microsoft Intune administration console](https://manage.microsoft.com), choose **Policy** &gt; **Compliance Policies** &gt; **Add**.
![IntuneSA3aAddCompliancePolicy](/Image/IntuneSA3aAddCompliancePolicy.png)

2.  On the **Create Policy** page, configure the settings you require:
![IntuneSA3bCreatePolicy](/Image/IntuneSA3bCreatePolicy.PNG)
...
![IntuneSA3cDeployCompliancePolicy2](/Image/IntuneSA3cDeployCompliancePolicy2.PNG)
...
![IntuneSA3dDeployCompliancePolicy3_Manage](/Image/IntuneSA3dDeployCompliancePolicy3_Manage.PNG)
...
![IntuneSA3eViewDeviceNoncomplaince](/Image/IntuneSA3eViewDeviceNoncomplaince.png)
