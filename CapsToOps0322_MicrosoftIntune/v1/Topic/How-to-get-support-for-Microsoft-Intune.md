...
For self help with [!INCLUDE[wit_nextref](../Token/wit_nextref_md.md)], see the [Documentation for Microsoft Intune](../Topic/Documentation-for-Microsoft-Intune.md) on TechNet, or click the Help link located at the top right-hand corner of the Intune administrative consoles.
...
### Support by phone
See [Contact Assisted Phone Support for Microsoft Intune](../Topic/Contact-Assisted-Phone-Support-for-Microsoft-Intune.md) for a list of support phone numbers by country and region, support hours, and supported languages for each region.
