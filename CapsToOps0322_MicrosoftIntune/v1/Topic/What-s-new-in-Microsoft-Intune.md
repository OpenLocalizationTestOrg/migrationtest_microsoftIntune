...
You can supply user settings that an iOS app might need when it is opened. For example, you can supply a network port, or a user name. For details, see [enter link description here](Configure-iOS-apps-with-mobile-app-configuration-policies-in-Microsoft-Intune.md).
...
## Archive
[February 2016](https://technet.microsoft.com/library/dn292747.aspx#BKMK_Feb2016)
[January 2016](https://technet.microsoft.com/library/dn292747.aspx#BKMK_Jan2016)
