...
**Note**: You may wish to first read the [[Get Started with Intune App SDK guide](Getting-Started-and-FAQ.xml)](intune), which covers the current features of the SDK and describes how to prepare for integration on each supported platform. 
