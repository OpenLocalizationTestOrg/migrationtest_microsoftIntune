...
1.  When you are ready to upload the app to your cloud storage space, follow the instructions in [Publish mobile device software to Microsoft Intune cloud storage](../Topic/Deploy-apps-to-mobile-devices-in-Microsoft-Intune.md).
...
For details, see [Deploy apps to mobile devices in Microsoft Intune](Deploy-apps-to-mobile-devices-in-Microsoft-Intune.md).
...
>
> When you deploy the policy to a device group, for apps that support multi-identity, the policy will apply to the enrolled user for the device. [See which apps support multi-identity](Microsoft-apps-you-can-use-with-Microsoft-Intune-mobile-application-management-policies.md).
