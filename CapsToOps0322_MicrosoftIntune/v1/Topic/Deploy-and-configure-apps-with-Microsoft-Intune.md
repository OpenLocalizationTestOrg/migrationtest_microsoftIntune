...
See [Configure apps with Microsoft Intune](../Topic/Configure-apps-with-Microsoft-Intune.md).
...
See [Update apps using Microsoft Intune](../Topic/Update-apps-using-Microsoft-Intune.md).
...
See [Retire apps using Microsoft Intune](../Topic/Retire-apps-using-Microsoft-Intune.md).
